...
export default function App() {
  ...
  return (
    <div
      className={`relative font-sans min-h-screen flex items-center justify-center overflow-hidden transition-colors duration-500 ${themeClasses.bg} ${themeClasses.text}`}
    >
      {/* Shapes */}
      <div
        className={`absolute -top-20 -left-20 w-80 h-80 border-8 rounded-full z-0 transition-colors ${themeClasses.shapeBorder}`}
      ></div>
      <div
        className={`absolute -bottom-24 -right-16 w-96 h-96 border-[12px] z-0 transition-colors ${themeClasses.shapeBorder}`}
      ></div>
      <div
        className={`absolute top-[55%] -right-24 w-60 h-60 rounded-full z-0 transition-colors ${themeClasses.shapeBg}`}
      ></div>
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-8 py-16">
        ...
        <main>
          ...
          <div
            className={`max-w-3xl space-y-6 leading-relaxed font-light ${
