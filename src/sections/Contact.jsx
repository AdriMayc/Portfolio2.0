          ...
          <form onSubmit={handleSubmit} className="max-w-xl space-y-6">
            <div>
              <input
                ...
                required
                className={`w-full p-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${themeClasses.inputBg} ${themeClasses.inputBorder} ${themeClasses.text} ${themeClasses.inputPlaceholder}`}
              />
            </div>
            <div>
              <input
            ...
            <button
              ...
              className={`inline-flex items-center px-6 py-3 rounded-full font-medium transition-colors ${themeClasses.buttonBg} ${themeClasses.buttonHover} ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
